...
"""
print('Loading data......')
sub_train_images, sub_train_labels, sub_test_images, sub_test_labels = init_subset('5799') # input your ASUID last 4 digits here to generate the subset samples of MNIST for training and testing
...
for e in range(epoch):
    ...
    test_acc_output.append(test_acc)
...
def plot_graphs(data, epochs, chart):
...
plot_graphs(train_acc_output, epochs, 'Training Accuracy')
plot_graphs(train_loss_output, epochs, 'Training Loss')
plot_graphs(test_acc_output, epochs, 'Testing Accuracy')
plot_graphs(test_loss_output, epochs, 'Testing Loss')

print('Training Accuracy Output Values')
print(train_acc_output)

print('Training Loss Output Values')
print(train_loss_output)

print('Testing Accuracy Output Values')
print(test_acc_output)

print('Testing Loss Output Values')
print(test_loss_output)

print('Epochs Output Values')
print(epochs)
