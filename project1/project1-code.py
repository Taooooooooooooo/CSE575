...
def main():
    ...
    # extract two features for each image：
    # assume：independent and normal distribution
    ...
    #print(arr_bright_digit0)
    #print(arr_std_digit0)
    #print(arr_bright_digit1)
    #print(arr_std_digit1)
    
    # calculate all the parameters for the two-class naive bayes classifiers respectively
    # mean variance 
    ...
    #print(output_digit0)
    #print(output_digit1)
    # calculate the accuracy of your predictions for testset for both digit0 and digit1 respectively.
